...
internal val CopyingTaskActionParser: TokenParser<TaskActionNode.Copying> =
	TokenParser(Iterator<Token>::parseNextFileCopyingTaskAction)

private fun Iterator<Token>.parseNextFileCopyingTaskAction(): TaskActionNode.Copying? {
